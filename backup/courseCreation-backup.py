...
# Load the first fine-tuned model for material generation
...
def query():
    ...
    #     out = chain.invoke(question)
        ...
        prompt = f"""Explain, with comprehensive detail and example of '{question}' in 2000 words, use proper markdown format (Title, Heading, etc). Dont provide Table of Contents"""
    ...
    # cleaned_text = re.sub(r'\\begin\{itemize\}|\\end\{itemize\}|\\begin\{align\*\}|\\end\{align\*\}|\\begin\{align\}', '', output_text)
